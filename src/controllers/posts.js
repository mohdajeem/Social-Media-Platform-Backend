...
const getById = async (req, res) => {
  try {
    ...
    const post = await getPostById(parseInt(postIdInt));
...
/**
 * Get content feed for current user (posts from followed users and self)
 */
...
/**
 * Search posts by content or media_url
 */
const search = async (req, res) => {
  try {
    ...
    const posts = await searchPosts(search, limit, offset);
